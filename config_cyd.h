...
// #define CONTROLLER_TYPE CT_UART // reads button presses over USB to serial connection or a dedicated UART
// https://github.com/jethomson/SerialGameControllerAdapter
#define CONTROLLER_TYPE CT_IO_EXPANDER

// IO Expander Configuration
// 0 = MCP23017, 1 = PCF8575
#define CONTROLLER_IO_EXPANDER_TYPE 0 
#define I2C_SDA 22
#define I2C_SCL 27
